...
QWEN_API_URL = "https://dashscope-intl.aliyuncs.com/api/v1"
...
def process_image(image, query, caption_model=CAPTION_MODEL):
    if QWEN_API_KEY is None:
        raise ValueError("QWEN_API_KEY environment variable is not set. Please set it before running the application.")
    
    # Use OpenAI client with compatible mode base URL as shown in the sample code
